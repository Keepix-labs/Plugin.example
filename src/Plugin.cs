...
public partial class Plugin
{
    ...
    //             var resultObject = await Task.Run(() => { return method.methodInfo.Invoke(null,new object[] { } ); } );
    ...
    //             var resultTaskObject = (Task<ExampleOutput>)method.methodInfo.Invoke(null,new object[] { param } );
                
    //             var resultObject = resultTaskObject?.GetAwaiter().GetResult();
    ...
    //             // await resultTaskObject.ConfigureAwait(true);
